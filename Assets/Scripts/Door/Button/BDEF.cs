...
public class BDEF : MonoBehaviour
{
...
void Start()
{
   button_def = GameObject.Find("Canvas/StatusPanel(buddy)/Status_Select/DEF").GetComponent<Button>();
   Def_Text = GameObject.Find("Canvas/StatusPanel(buddy)/Status_Select/DEF/Counter").GetComponent<Text>();
   def_status_panel = GameObject.Find("Canvas/StatusPanel(buddy)/Status_Select/DEF/StatusDEFPanel");
...
public void DEFbuttonOperation()
    {
        ...
        {
            GameObject.Find($"Canvas/StatusPanel(buddy)/Status_Select/DEF/StatusDEFPanel/{status_def}").SetActive(false);
        ...
        if(Input.GetKeyDown(KeyCode.RightArrow) && rest != "残り:0") 
        {
            ...
            GameObject.Find($"Canvas/StatusPanel(buddy)/Status_Select/DEF/StatusDEFPanel/{status_def}").SetActive(true);
        }
