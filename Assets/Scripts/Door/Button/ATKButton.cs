...
void Start()
{
   ...
   Atk_Text = GameObject.Find("Canvas/StatusPanel/Status_Select/ATK/Counter").GetComponent<Text>();
   atk_status_panel = GameObject.Find("Canvas/StatusPanel/Status_Select/ATK/StatusATKPanel");
...
public void ATKbuttonOperation()
    {
        ...
        {
            GameObject.Find($"Canvas/StatusPanel/Status_Select/ATK/StatusATKPanel/{status_atk}").SetActive(false);
        ...
        if(Input.GetKeyDown(KeyCode.RightArrow) && rest != "残り:0") 
        {
            ...
            GameObject.Find($"Canvas/StatusPanel/Status_Select/ATK/StatusATKPanel/{status_atk}").SetActive(true);
        }
