...
public class BAGI : MonoBehaviour
{
...
void Start()
{
   button_agi = GameObject.Find("Canvas/StatusPanel(buddy)/Status_Select/AGI").GetComponent<Button>();
   Agi_Text = GameObject.Find("Canvas/StatusPanel(buddy)/Status_Select/AGI/Counter").GetComponent<Text>();
   agi_status_panel = GameObject.Find("Canvas/StatusPanel(buddy)/Status_Select/AGI/StatusAGIPanel");
...
public void AGIbuttonOperation()//選択されているとき
    {
        ...
        {
            GameObject.Find($"Canvas/StatusPanel(buddy)/Status_Select/AGI/StatusAGIPanel/{status_agi}").SetActive(false);
        ...
        if(Input.GetKeyDown(KeyCode.RightArrow) && rest != "残り:0") 
        {
            ...
            GameObject.Find($"Canvas/StatusPanel(buddy)/Status_Select/AGI/StatusAGIPanel/{status_agi}").SetActive(true);
        }
